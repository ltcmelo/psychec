...
#ifndef PSYCHE_STDLIB_INTERCEPTOR_H__
#define PSYCHE_STDLIB_INTERCEPTOR_H__
...
{
public:
    bool intercept(SimpleDeclarationAST*) override;
    bool intercept(FunctionDefinitionAST*) override;

private:
    bool isStdName(const Name* name) const;
